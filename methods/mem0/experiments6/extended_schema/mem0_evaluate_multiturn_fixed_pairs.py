...
SOURCE_MODULE_PATH = str(Path(SOURCE_DIR) / "step2_evaluate_multiturn.py")
...
EXTENDED_MULTITURN_PATH = str(RELEASE_ROOT / "query_new_multi.json")
...
EXTENDED_SCHEMA_PATH = str(RELEASE_ROOT / "schema_all_extended_complete.json")
