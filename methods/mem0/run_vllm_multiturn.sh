#!/bin/bash
# Run mem0 multi-turn inference via vLLM (OpenAI-compatible endpoint).
...
BASE_OUTPUT_DIR="$ROOT_DIR/outputs/mem0/vllm/multiturn"
BASE_LOG_DIR="$ROOT_DIR/logs/mem0/vllm/multiturn"
...
echo "========================================================"
echo "mem0 vLLM Multi-turn Inference Started at $(date)"
