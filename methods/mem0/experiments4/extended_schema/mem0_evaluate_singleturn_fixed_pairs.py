...
SOURCE_MODULE_PATH = f"{SOURCE_DIR}/step2_evaluate_singleturn.py"
...
EXTENDED_QUERY_PATH = "/data/minseo/experiments4/query_new_single.json"
...
EXTENDED_SCHEMA_PATH = "/data/minseo/experiments4/schema_easy_extended.json"
