...
from common import (
    ...
    DEFAULT_SCHEMA_PATH,
    DEFAULT_SINGLETURN_QUERY_PATH,
    default_run_log_path,
    prepare_singleturn_items,
    run_inference_async,
)
from src.prompts import IMPLICIT_ZS_PROMPT_MEMORY_TEMPLATE
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_path", type=str, default="output_emem_single.json")
    parser.add_argument("--log_path", type=str, default="output_emem_single.jsonl")
    parser.add_argument("--run_log_path", type=str, default=None)
    parser.add_argument("--query_path", type=str, default=DEFAULT_SINGLETURN_QUERY_PATH)
...
async def main() -> None:
    ...
    prepared_items = prepare_singleturn_items(
