...
try:
    ...
    EMEM_IMPORT_ERROR: ImportError | None = None
except ImportError as exc:
    EMem = None  # type: ignore[assignment]
    BaseConfig = None  # type: ignore[assignment]
    Conversation = None  # type: ignore[assignment]
    EventSummary = None  # type: ignore[assignment]
    LoCoMoSample = None  # type: ignore[assignment]
    Observation = None  # type: ignore[assignment]
    Session = None  # type: ignore[assignment]
    Turn = None  # type: ignore[assignment]
    EMEM_IMPORT_ERROR = exc


def require_emem_runtime() -> None:
    if EMEM_IMPORT_ERROR is not None:
        raise RuntimeError(
            "EMem runtime dependencies are required for this command. "
            "Install the EMem extras before building indexes or evaluating EMem."
        ) from EMEM_IMPORT_ERROR


DEFAULT_INPUT_PATH = "/data/minseo/experiments5/data/1229_dev_6.json"
DEFAULT_SINGLETURN_QUERY_PATH = "/data/minseo/experiments5/config/query_singleturn.json"
DEFAULT_MULTITURN_QUERY_PATH = "/data/minseo/experiments5/config/query_multiturn-domain.json"
DEFAULT_PREF_LIST_PATH = "/data/minseo/experiments5/config/pref_list.json"
DEFAULT_PREF_GROUP_PATH = "/data/minseo/experiments5/config/pref_group.json"
DEFAULT_SCHEMA_PATH = "/data/minseo/experiments5/config/schema_all.json"
DEFAULT_INDEX_ROOT = "/data/minseo/experiments5/methods/emem/indexes/emem_1229_dev_6"
DEFAULT_MANIFEST_PATH = "/data/minseo/experiments5/methods/emem/output/emem_1229_dev_6.manifest.jsonl"
