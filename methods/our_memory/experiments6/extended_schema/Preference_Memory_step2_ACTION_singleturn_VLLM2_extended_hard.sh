...
PYTHON_SCRIPT="$RELEASE_ROOT/extended_schema/ours_memory/Preference_Memory_step2_ACTION_singleturn_api_fixed_pairs.py"
...
STOP_AFTER_MEMORY_FOLDER="${STOP_AFTER_MEMORY_FOLDER:-}"
STOP_RUN_AFTER_TARGET_MEMORY="${STOP_RUN_AFTER_TARGET_MEMORY:-0}"
