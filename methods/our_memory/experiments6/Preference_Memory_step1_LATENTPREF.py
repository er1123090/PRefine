...
class PreferenceAggregator:
    def __init__(self, model: str, provider: str, api_key: str, api_base: Optional[str] = None):
        self.model = model
        self.provider = provider.lower()
        self.api_key = api_key
        self.api_base = api_base
        self.max_retries = 10 # 최대 10회 시도 (1회 초기 + 9회 개선)
...
def resolve_output_paths(args: argparse.Namespace) -> argparse.Namespace:
    ...
    if treat_as_directory:
        ...
        args.output = os.path.join(output_path, "_memory1.jsonl")
        args.verifier_output = os.path.join(output_path, "_verifier_logs1.jsonl")
        args.refinement_output = os.path.join(output_path, "_refinement_logs1.jsonl")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="/data/minseo/experiments6/data/1229_dev_6.json", help="Path to input JSON file")
