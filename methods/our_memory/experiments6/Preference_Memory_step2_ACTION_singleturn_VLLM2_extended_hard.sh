...
for model in "${MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments6/ours_memory/inference/extended/outputs/singleturn/vllm/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments6/ours_memory/inference/extended/logs/singleturn/vllm/${MEM_FOLDER}"
