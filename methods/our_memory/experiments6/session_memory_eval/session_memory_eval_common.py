...
RELEASE_ROOT = PACKAGE_ROOT.parents[2]

DEFAULT_MEMORY_ROOT = RELEASE_ROOT / "ours_memory" / "inference" / "0312_MEMORY1"
DEFAULT_DATASET_PATH = RELEASE_ROOT / "data" / "1229_dev_6.json"
DEFAULT_STEP2_PYTHON = RELEASE_ROOT / "ours_memory" / "Preference_Memory_step2_ACTION_singleturn_VLLM.py"
DEFAULT_QUERY_PATH = RELEASE_ROOT / "query_singleturn.json"
DEFAULT_PREF_LIST_PATH = RELEASE_ROOT / "pref_list.json"
DEFAULT_PREF_GROUP_PATH = RELEASE_ROOT / "pref_group.json"
DEFAULT_TOOLS_SCHEMA_PATH = RELEASE_ROOT / "schema_easy.json"
