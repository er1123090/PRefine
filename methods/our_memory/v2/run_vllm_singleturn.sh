#!/bin/bash
# Run Our Memory single-turn inference via vLLM (OpenAI-compatible endpoint).
...
BASE_OUTPUT_DIR="$ROOT_DIR/outputs/our_memory/vllm/singleturn"
BASE_LOG_DIR="$ROOT_DIR/logs/our_memory/vllm/singleturn"
...
echo "========================================================"
echo "Our Memory vLLM Single-turn Inference Started at $(date)"
