...
SOURCE_MODULE_PATH = f"{SOURCE_DIR}/Preference_Memory_step2_ACTION_singleturn_api.py"
...
def main() -> None:
    ...
    parser.add_argument("--query_path", type=str, default="/data/minseo/experiments4/query_new_single.json")
    ...
    parser.add_argument("--tools_schema_path", type=str, default="/data/minseo/experiments4/schema_easy_extended.json")
