...
SOURCE_DIR = "/data/minseo/experiments4/ours_memory"
SOURCE_MODULE_PATH = f"{SOURCE_DIR}/Preference_Memory_step2_ACTION_multiturn_api.py"
source = load_python_module(
    SOURCE_MODULE_PATH,
    "extended_schema_ours_multi_source",
...
def main() -> None:
    ...
    parser.add_argument("--multiturn_path", type=str, default="/data/minseo/experiments4/query_new_multi.json")
    parser.add_argument("--pref_list_path", type=str, default="/data/minseo/experiments4/pref_list_extended.json")
    parser.add_argument("--pref_group_path", type=str, default="/data/minseo/experiments4/pref_group_extended.json")
    parser.add_argument("--tools_schema_path", type=str, default="/data/minseo/experiments4/schema_all_extended_complete.json")
    ...
    asyncio.run(
        process_with_llm_async(
            ...
            prompt_template=source.IMPLICIT_ZS_PROMPT_MEMORY_TEMPLATE_MULTITURN,
