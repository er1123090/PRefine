...
- `0312_MEMORY1_max10`: `/data/minseo/experiments4/ours_memory/inference/0312_MEMORY1`
- `1231_MEMORY3_max3`: `/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3`

Comparison script:

- `/data/minseo/experiments4/ours_memory/compare_iteration_caps.py`
- `/data/minseo/experiments4/ours_memory/plot_refinement_tail.py`

Main figure:

- `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/0312_MEMORY1_max10_refinement_tail.png`
...
- Refinement totals:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/refinement_totals.csv`
- Refinement by model:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/refinement_by_model.csv`
- Multiturn common subset:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/multiturn_common_subset.csv`
- Multiturn by difficulty:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/multiturn_by_pref.csv`
- Singleturn common subset:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/singleturn_common_subset.csv`
- Singleturn by difficulty:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/singleturn_by_pref.csv`
- Refinement tail figure:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/0312_MEMORY1_max10_refinement_tail.png`
- First-valid-step table for the figure:
  - `/data/minseo/experiments4/ours_memory/iteration_cap_comparison/0312_MEMORY1_max10_first_valid_steps.csv`
