#!/bin/bash
# Run RAG single-turn inference via vLLM (OpenAI-compatible endpoint).
...
BASE_OUTPUT_DIR="$ROOT_DIR/outputs/rag/vllm/singleturn"
BASE_LOG_DIR="$ROOT_DIR/logs/rag/vllm/singleturn"
...
echo "========================================================"
echo "RAG vLLM Single-turn Inference Started at $(date)"
