...
def parse_deepseek_reasoning(raw_content: str) -> Dict[str, str]:
    ...
    Useful for vLLM hosted DeepSeek models.
    """
    if not raw_content:
...
# ---------------------------------------------------------
# 4. Async LLM Call (Refactored for Reasoning)
# ---------------------------------------------------------
...
if __name__ == "__main__":
    ...
    parser.add_argument("--multiturn_path", type=str, default="/data/minseo/experiment8/config/query_multiturn_hint.json", help="Path to multi-turn query json") 
    ...
    parser.add_argument("--tools_schema_path", type=str, default="/data/minseo/experiment8/config/schema_all.json")
