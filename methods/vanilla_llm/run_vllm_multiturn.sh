#!/bin/bash
# Run vanilla LLM multi-turn inference via vLLM (OpenAI-compatible endpoint).
...
BASE_OUTPUT_DIR="$ROOT_DIR/outputs/vanilla_llm/vllm/multiturn"
BASE_LOG_DIR="$ROOT_DIR/logs/vanilla_llm/vllm/multiturn"
