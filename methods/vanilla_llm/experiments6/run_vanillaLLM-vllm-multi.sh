...
MULTITURN_PATH="/data/minseo/experiments6/query_multiturn-domain.json"
...
BASE_OUTPUT_DIR="/data/minseo/experiments6/vanillaLLM/inference/1230-1_output"
BASE_LOG_DIR="/data/minseo/experiments6/vanillaLLM/inference/1230-1_logs"
...
# GPU & Server Settings
GPU_ID=2,3
PORT=8001          # Changed port to avoid conflict with single-turn script
...
TP_SIZE=2 # Tensor Parallelism Size (4 GPUs)
