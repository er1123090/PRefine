...
BASE_OUTPUT_DIR="/data/minseo/experiments6/vanillaLLM/inference/extended/outputs/singleturn/api"
BASE_LOG_DIR="/data/minseo/experiments6/vanillaLLM/inference/extended/logs/singleturn/api"
