...
# 결과 저장 루트 디렉토리
BASE_OUTPUT_DIR="/data/minseo/experiments6/vanillaLLM/inference/1229-3_output"
BASE_LOG_DIR="/data/minseo/experiments6/vanillaLLM/inference/1229-3_logs"
...
TP_SIZE=2 # Tensor Parallelism Size (GPU 1장 = 1)
