#!/bin/bash
# Run vanilla LLM single-turn inference via API (OpenAI / Gemini / Anthropic).
...
BASE_OUTPUT_DIR="$ROOT_DIR/outputs/vanilla_llm/api/singleturn"
BASE_LOG_DIR="$ROOT_DIR/logs/vanilla_llm/api/singleturn"
