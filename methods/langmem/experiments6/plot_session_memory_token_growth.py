...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input_csv",
        type=str,
        default="/data/minseo/experiments6/langmem/session_memory_token_deltas_1229_dev_6.csv",
    )
    parser.add_argument(
        "--dialogue_data_path",
        type=str,
    ...
    parser.add_argument(
        "--output_png",
        type=str,
        default="/data/minseo/experiments6/langmem/session_memory_token_growth.png",
    )
    parser.add_argument(
        "--output_summary_csv",
        type=str,
        default="/data/minseo/experiments6/langmem/session_memory_token_growth.summary.csv",
    )
