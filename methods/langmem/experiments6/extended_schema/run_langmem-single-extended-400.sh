...
PYTHON_SCRIPT="$RELEASE_ROOT/extended_schema/langmem/langmem_inference_single_fixed_pairs.py"
...
MEMORY_ROOT="${MEMORY_ROOT:-$RELEASE_ROOT/langmem/memory_snapshots/semantic-custom}"
CANONICAL_SNAPSHOT_NAME="${CANONICAL_SNAPSHOT_NAME:-langmem_1229_dev_6.jsonl}"

RUN_ROOT="$RELEASE_ROOT/extended_schema/langmem/output"
DATE_TAG="$(date +%m%d)"
...
echo "========================================================"
echo "LangMem Fixed-400 Single-turn Started at $(date)"
...
for model in "${MODELS[@]}"; do
    ...
    for memory_folder in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="$RUN_ROOT/singleturn/$BACKEND_TAG/$memory_folder"
        BASE_LOG_DIR="$RUN_ROOT/logs/singleturn/$BACKEND_TAG/$memory_folder"
...
echo "========================================================"
echo "LangMem Fixed-400 Single-turn Finished at $(date)"
echo "========================================================"
