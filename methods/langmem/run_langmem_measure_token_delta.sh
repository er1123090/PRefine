...
PYTHON_SCRIPT="/data/minseo/experiments5/methods/langmem/measure_session_memory_token_delta.py"
BASE_DIR="/data/minseo/experiments5"
OUTPUT_DIR="${BASE_DIR}/methods/langmem/token_growth/gpt-4o-mini"
