    ...
    async def process_item(index: int, item: Dict[str, Any]) -> None:
        ...
        async with semaphore:
            ...
            try:
                ...
                retrieval_prompt_tokens = count_string_tokens(
                    retrieved_memories_text, encoding
                )
                ...
                log_record = {
                    ...
                    "retrieval_token_encoding": DEFAULT_ENCODING,
                ...
                result_ex["retrieval_token_encoding"] = DEFAULT_ENCODING
