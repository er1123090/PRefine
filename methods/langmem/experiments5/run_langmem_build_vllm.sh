...
INPUT_DATA="${INPUT_DATA:-/data/minseo/experiments5/data/1229_dev_6.json}"
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/data/minseo/experiments5/methods/langmem/memory_snapshots/semantic-custom}"
