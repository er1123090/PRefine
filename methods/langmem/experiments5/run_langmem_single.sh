...
PYTHON_SCRIPT="/data/minseo/experiments5/methods/langmem/langmem_inference_single.py"
...
TOOLS_SCHEMA_PATH="${BASE_DIR}/config/schema_easy.json"
MEMORY_ROOT="${MEMORY_ROOT:-${BASE_DIR}/methods/langmem/memory_snapshots/semantic-custom}"
OUTPUT_ROOT="${BASE_DIR}/methods/langmem/inference_single"
