...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dialogue_data_path",
        type=str,
        default="/data/minseo/experiments5/data/1229_dev_6.json",
    )
    parser.add_argument(
        "--output_png",
        type=str,
        default="/data/minseo/experiments5/methods/langmem/session_memory_token_growth.png",
    )
    parser.add_argument(
        "--output_summary_csv",
        type=str,
        default="/data/minseo/experiments5/methods/langmem/session_memory_token_growth.summary.csv",
    )
