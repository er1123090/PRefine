...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="/data/minseo/experiments4/mem0",
    )
    parser.add_argument(
        "--csv_glob",
        type=str,
    ...
    parser.add_argument(
        "--output_csv",
        type=str,
        default="/data/minseo/experiments4/mem0/session_memory_token_deltas_1229_dev_6.merged.csv",
    )
    parser.add_argument(
        "--output_summary",
        type=str,
        default="/data/minseo/experiments4/mem0/session_memory_token_deltas_1229_dev_6.merged.summary.json",
    )
