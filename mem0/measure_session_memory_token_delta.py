...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_csv",
        type=str,
        default="/data/minseo/experiments4/mem0/session_memory_token_deltas_1229_dev_6.csv",
    )
    parser.add_argument(
        "--summary_json",
        type=str,
        default="/data/minseo/experiments4/mem0/session_memory_token_deltas_1229_dev_6.summary.json",
    )
    parser.add_argument(
        "--app_id",
        type=str,
        default="experiments4-session-token-delta-20260323",
        help=(
