...
PYTHON_SCRIPT="/data/minseo/experiments4/langmem/step1_build_memory.py"
INPUT_DATA="${INPUT_DATA:-/data/minseo/experiments4/data/1229_dev_6.json}"
BASE_OUTPUT_DIR="${BASE_OUTPUT_DIR:-/data/minseo/experiments4/langmem/memory_snapshots/semantic-custom}"
