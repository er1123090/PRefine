...
DEFAULT_MEMORY_A = Path("/data/minseo/experiments6/ours_memory/inference/0312_MEMORY1")
DEFAULT_MEMORY_B = Path("/data/minseo/experiments6/ours_memory/inference/1231_MEMORY3")
DEFAULT_MULTI_A = Path(
    "/data/minseo/experiments6/ours_memory/inference/0312_MEMORY1_0317_MEM-DIAG/analysis/multiturn_performance_table.csv"
)
DEFAULT_SINGLE_A = Path(
    "/data/minseo/experiments6/ours_memory/inference/0312_MEMORY1_0317_MEM-DIAG/analysis/singleturn_performance_table.csv"
)
DEFAULT_MULTI_B = Path("/data/minseo/experiments6/evaluation/eval_results/results_memory_multiturn2.csv")
DEFAULT_SINGLE_B = Path("/data/minseo/experiments6/evaluation/eval_results/results_memory_singleturn2.csv")
