...
RELEASE_ROOT="$(cd "$PACKAGE_ROOT/../../.." && pwd)"

PYTHON_SCRIPT="$RELEASE_ROOT/ours_memory/Preference_Memory_step2_ACTION_singleturn_VLLM.py"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$PACKAGE_ROOT/outputs/runs/singleturn}"
...
echo "========================================================"
echo "Starting standalone session-memory evaluation runs"
echo "========================================================"
...
echo "========================================================"
echo "Finished standalone session-memory evaluation runs"
echo "========================================================"
if [[ "$DRY_RUN" != "1" ]]; then
