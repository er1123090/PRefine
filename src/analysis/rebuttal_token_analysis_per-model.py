...
data_file_path = '/data/minseo/experiments6/data/1229_dev_6.json'
...
memory_base_dir = '/data/minseo/experiments6/ours_memory/inference/1231_MEMORY3_ plot'
...
# --- Task 3: Plotting ---
output_plot_path = '/data/minseo/experiments6/token_evolution_plot.png'
