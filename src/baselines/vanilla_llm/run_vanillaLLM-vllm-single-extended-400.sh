...
# 1. Environment & Paths
# ==============================================================================
PYTHON_SCRIPT="/data/minseo/experiments6/vanillaLLM/vanillaLLM_inference-vllm-single.py"

INPUT_PATH="/data/minseo/experiments6/data/1229_dev_6.json"
QUERY_PATH="/data/minseo/experiments6/query_singleturn_extended.json"
...
BASE_OUTPUT_DIR="/data/minseo/experiments6/vanillaLLM/inference/extended/outputs/singleturn/vllm"
BASE_LOG_DIR="/data/minseo/experiments6/vanillaLLM/inference/extended/logs/singleturn/vllm"
