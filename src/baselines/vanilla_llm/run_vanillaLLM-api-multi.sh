...
# 데이터 및 스키마 경로
INPUT_PATH="/data/minseo/experiments6/data/1229_dev_6_SAMPLED_100.json"      

#"/data/minseo/experiments6/data/1229_dev_6.json"

# [수정됨] 기존 QUERY_PATH -> MULTITURN_QUERY_PATH로 변경
MULTITURN_QUERY_PATH="/data/minseo/experiments6/query_multiturn-domain.json"
...
# 출력 및 로그 디렉토리
BASE_OUTPUT_DIR="/data/minseo/experiments6/vanillaLLM/inference/0104-1_output_multiturn_1229_dev_6_SAMPLED_100"
BASE_LOG_DIR="/data/minseo/experiments6/vanillaLLM/inference/0104-1_logs_multiturn_1229_dev_6_SAMPLED_100"
        ...
        for context in "${CONTEXT_TYPES[@]}"; do
            for pref in "${PREF_TYPES[@]}"; do
                for effort in "${EFFORT_LEVELS[@]}"; do
                    ...
                    OUTPUT_DIR="$BASE_OUTPUT_DIR/$context/$pref/multiturn-query/$MODEL_SAFE_NAME-$effort/$prompt_type"
                    LOG_DIR="$BASE_LOG_DIR/$context/$pref/multiturn-query/$MODEL_SAFE_NAME-$effort/$prompt_type"
