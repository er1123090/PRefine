...
BASE_DIR="/data/minseo/experiments6/mem0"
DATASET_PATH="/data/minseo/experiments6/data/1229_dev_6.json"
...
config = {
    "dataset_path": "/data/minseo/experiments6/data/1229_dev_6.json",
    "output_root": "/data/minseo/experiments6/mem0/0323_memory-tokens_265",
...
for i in "${!SHARD_IDS[@]}"; do
  ...
  app_id="experiments6-session-token-delta-${RUN_STAMP}-shard${shard_id}"
