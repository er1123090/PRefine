...
PYTHON_SCRIPT="$RELEASE_ROOT/extended_schema/mem0/mem0_evaluate_singleturn_fixed_pairs.py"
...
RUN_ROOT="$RELEASE_ROOT/extended_schema/mem0/output"
DATE_TAG="$(date +%m%d)"
...
echo "========================================================"
echo "Mem0 Fixed-400 Single-turn Started at $(date)"
...
echo "========================================================"
echo "Mem0 Fixed-400 Single-turn Finished at $(date)"
echo "========================================================"
