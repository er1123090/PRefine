...
EXTENDED_ROOT = RELEASE_ROOT / "src" / "extended_schema"
THIS_DIR = Path(__file__).resolve().parent
EVAL_ROOT = RELEASE_ROOT / "src" / "preference_memory" / "session_memory_eval"
...
def build_singleturn_rows() -> List[Dict[str, Any]]:
    configs = [
        ("vanilla_llm", EXTENDED_ROOT / "vanillaLLM" / "output" / "singleturn" / "api"),
...
def build_multiturn_rows() -> List[Dict[str, Any]]:
    ...
    configs = [
        ("vanilla_llm", EXTENDED_ROOT / "vanillaLLM" / "output" / "multiturn" / "api"),
