...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path", type=str, default="/data/minseo/experiments6/data/sgd_converted_dev_mapped_grouped_with_pref_with_constraints.json")
    ...
    parser.add_argument("--query_path", type=str, default="/data/minseo/experiments6/ours_memory/temp_queries.json")
    parser.add_argument("--pref_list_path", type=str, default="/data/minseo/experiments6/ours_memory/pref_list.json")
