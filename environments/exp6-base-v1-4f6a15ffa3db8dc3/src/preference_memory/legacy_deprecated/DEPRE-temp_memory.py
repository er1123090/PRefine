...
if __name__ == "__main__":
    ...
    # Path Arguments
    parser.add_argument("--input_path", type=str, default="/data/minseo/experiments6/data/sgd_converted_dev_mapped_grouped_with_pref_with_constraints.json", help="Path to input dataset (.json or .jsonl)")
    ...
    parser.add_argument("--query_path", type=str, default="/data/minseo/experiments6/ours_memory/temp_queries.json", help="Path to query mapping json")
    
    # pref_list_path는 required에 경로값이 아닌 boolean이 와야 하므로 default로 변경
    parser.add_argument("--pref_list_path", type=str, default="/data/minseo/experiments6/ours_memory/pref_list.json", help="Path to preference list json")
