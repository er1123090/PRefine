...
# Python 스크립트 절대 경로
PYTHON_SCRIPT="/data/minseo/experiments6/ours_memory/Preference_Memory_step2_ACTION_singleturn_VLLM.py"  # 저장한 파이썬 파일명으로 변경하세요

# 데이터 및 리소스 경로
INPUT_PATH="/data/minseo/experiments6/data/1229_dev_6.json"
MEMORY_PATH="/data/minseo/experiments6/ours_memory/inference/1231_MEMORY3/gpt-4o-mini/_memory1.jsonl" # [중요] Python 코드에서 요구하는 메모리 파일 경로
...
BASE_LOG_DIR="/data/minseo/experiments6/ours_memory/inference/1231_MEMORY3_logs1_single/gpt-4o-mini"
