...
for INF_MODEL in "${INFERENCE_MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments6/ours_memory/inference/extended/outputs/multiturn/vllm/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments6/ours_memory/inference/extended/logs/multiturn/vllm/${MEM_FOLDER}"
