...
def main():
    ...
    dialogue_file = '/data/minseo/experiments6/data/1229_dev_6.json'
    dialogue_avg = process_dialogue_data(dialogue_file, enc)
    
    # 2. Process Ours (Memory) - Per Model
    memory_base_path = '/data/minseo/experiments6/ours_memory/inference/1231_MEMORY3_plot'
    ...
    output_png = '/data/minseo/experiments6/token_growth_comparison_combined_new.png'
