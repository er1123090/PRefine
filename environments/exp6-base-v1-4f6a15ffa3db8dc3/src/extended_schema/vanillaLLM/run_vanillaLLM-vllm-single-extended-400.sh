...
PYTHON_SCRIPT="$RELEASE_ROOT/extended_schema/vanillaLLM/vanillaLLM_inference-api-single_fixed_pairs.py"
...
echo "========================================================"
echo "VanillaLLM Fixed-400 vLLM Single-turn Started at $(date)"
...
echo "========================================================"
echo "VanillaLLM Fixed-400 vLLM Single-turn Finished at $(date)"
echo "========================================================"
