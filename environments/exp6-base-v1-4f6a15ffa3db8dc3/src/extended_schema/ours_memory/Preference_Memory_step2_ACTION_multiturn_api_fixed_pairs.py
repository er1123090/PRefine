...
SOURCE_MODULE_PATH = str(Path(SOURCE_DIR) / "Preference_Memory_step2_ACTION_multiturn_api.py")
...
def main() -> None:
    ...
    parser.add_argument("--multiturn_path", type=str, default=str(RELEASE_ROOT / "query_new_multi.json"))
    ...
    parser.add_argument("--tools_schema_path", type=str, default=str(RELEASE_ROOT / "schema_all_extended_complete.json"))
