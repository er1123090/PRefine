...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path", type=str, default=str(RELEASE_ROOT / "data" / "sgd_converted_dev_mapped_grouped_with_pref_with_constraints.json"))
    ...
    parser.add_argument("--query_path", type=str, default=str(RELEASE_ROOT / "query_singleturn.json"))
    parser.add_argument("--pref_list_path", type=str, default=str(RELEASE_ROOT / "pref_list.json"))
