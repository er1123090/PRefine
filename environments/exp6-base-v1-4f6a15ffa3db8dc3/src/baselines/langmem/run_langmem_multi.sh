...
PYTHON_SCRIPT="/data/minseo/experiments6/langmem/langmem_inference_multi.py"
BASE_DIR="/data/minseo/experiments6"
INPUT_PATH="${BASE_DIR}/data/1229_dev_6.json"
MULTITURN_PATH="${BASE_DIR}/query_multiturn.json"
...
OUTPUT_ROOT="${BASE_DIR}/langmem/inference_multi_low"
