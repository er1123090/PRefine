...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a LangMem semantic-memory snapshot from the experiments6 dataset."
    )
    parser.add_argument("--input_path", type=str, default=DEFAULT_INPUT_PATH)
    parser.add_argument(
        "--output_path",
        type=str,
        default="/data/minseo/experiments6/langmem/memory_snapshots/langmem_1229_dev_6.jsonl",
    )
    parser.add_argument(
        "--manifest_path",
        type=str,
        default="/data/minseo/experiments6/langmem/memory_snapshots/langmem_1229_dev_6.manifest.json",
    )
