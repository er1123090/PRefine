...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default="/data/minseo/experiments4/langmem/memory_snapshots/langmem_1229_dev_6.jsonl",
    )
    parser.add_argument(
        "--manifest_path",
        type=str,
        default="/data/minseo/experiments4/langmem/memory_snapshots/langmem_1229_dev_6.manifest.json",
    )
