...
class EmbeddingStore:
    ...
    def insert_strings(self, texts: List[str], encoding_instruction: Optional[str] = None):
        nodes_dict = {}
        ...
        if encoding_instruction is None:
            logger.info(f"Encoding {len(texts_to_encode)} strings without instruction prefix")
