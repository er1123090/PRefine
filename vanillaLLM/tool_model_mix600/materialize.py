    ...
    for target in targets:
        ...
        for mode in MODES:
            ...
            cases.append({
                ...
                "model_input": prompt,
                "request": build_request(prompt, tools, model_id=model_id, reasoning_effort=reasoning_effort),
            })
...
def main() -> None:
    ...
    parser.add_argument("--experiment", default="tool_model_mix600_vanilla_llm")
    ...
    code_paths = sorted((repo / "vanillaLLM/tool_model_mix600").glob("*.py"))
    ...
    cases = render_cases(
        targets, dataset_by_id, single_queries, multi_templates, tools, schemas, prompt_template,
        args.model_id, args.reasoning_effort,
    )
