...
MULTITURN_QUERY_PATH="/data/minseo/experiments4/query_new_multi.json"
...
BASE_OUTPUT_DIR="/data/minseo/experiments4/vanillaLLM/inference/extended/outputs/multiturn/api"
BASE_LOG_DIR="/data/minseo/experiments4/vanillaLLM/inference/extended/logs/multiturn/api"
