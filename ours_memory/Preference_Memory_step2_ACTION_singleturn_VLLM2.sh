...
for model in "${MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/0312_MEMORYY1_0318_MEM-DIAG/singeturn/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/0312_MEMORYY1_0318_MEM-DIAG/singeturn/${MEM_FOLDER}"
