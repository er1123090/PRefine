...
for model in "${MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_inference2_multi/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_logs2_multi/${MEM_FOLDER}"
