...
for INF_MODEL in "${INFERENCE_MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        MEMORY_PATH="/data/minseo/experiments4/ours_memory/inference/0312_MEMORY1/${MEM_FOLDER}/_memory1.jsonl"
        
        # 2. 결과 저장 경로: [추론모델명]/[메모리출처] 형태로 계층화
        # 예: .../inference/google_gemma-3-12b-it/mem_source_llama-3/...
        BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/0312_MEMORY1_0317_MEM-DIAG/multiturn/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/0312_MEMORY1_0317_MEM-DIAG/multiturn/${MEM_FOLDER}"
