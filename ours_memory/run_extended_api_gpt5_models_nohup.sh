...
BASE_ROOT="/data/minseo/experiments4/ours_memory/inference/extended"

INPUT_PATH="/data/minseo/experiments4/data/1229_dev_6.json"
SINGLE_QUERY_PATH="/data/minseo/experiments4/query_new_single.json"
MULTI_QUERY_PATH="/data/minseo/experiments4/query_new_multi.json"
...
SINGLE_PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step2_ACTION_singleturn_api.py"
MULTI_PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step2_ACTION_multiturn_api.py"
...
run_singleturn_for_model() {
    ...
    for mem_folder in "${MEMORY_FOLDERS[@]}"; do
        ...
        local memory_path="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3/${mem_folder}/_memory1.jsonl"
