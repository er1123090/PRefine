...
# Python 스크립트 경로
PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step2_ACTION_singleturn_api.py"

# 데이터 경로
INPUT_PATH="/data/minseo/experiments4/data/1229_dev_6.json"
MEMORY_PATH="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3/deepseek-ai_DeepSeek-R1-0528-Qwen3-8B/_memory1.jsonl"
...
# 결과 저장 루트 디렉토리
BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_inference1_single/DeepSeek-R1-0528-Qwen3-8B"
BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_logs1_single/DeepSeek-R1-0528-Qwen3-8B"
