...
# Python 스크립트 절대 경로
PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step1_LATENTPREF_ablation.py"

# 입력 데이터 경로
INPUT_DATA="/data/minseo/experiments4/data/1229_dev_6.json"

# 결과 저장 최상위 루트
BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/0216_MEMORY"
