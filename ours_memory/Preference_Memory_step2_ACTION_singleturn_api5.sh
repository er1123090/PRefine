...
TOOLS_SCHEMA_PATH="/data/minseo/experiments4/schema_easy.json" # 기존 스크립트 설정 유지
...
for model in "${MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_0311_single_mem-only/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_0311_single_mem-only/${MEM_FOLDER}"
