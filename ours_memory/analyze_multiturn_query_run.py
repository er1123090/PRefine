...
DEFAULT_ROOT_DIR = Path("/data/minseo/experiments4/ours_memory/inference/1231_MEMORY3_inference2_multi")
DEFAULT_PREF_LIST_PATH = Path("/data/minseo/experiments4/pref_list.json")
EVAL_SCRIPT_PATH = Path("/data/minseo/experiments4/evaluation/evaluation_multiturn-f1-parse-aggregate.py")
