...
PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step1_LATENTPREF_VLLM.py"

# 입력 데이터 경로
INPUT_DATA="/data/minseo/experiments4/data/1229_dev_6.json"

# 결과 저장 루트 디렉토리
BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/0312_MEMORY1"
