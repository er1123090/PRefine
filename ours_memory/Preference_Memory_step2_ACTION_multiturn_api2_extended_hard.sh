...
PYTHON_SCRIPT="/data/minseo/experiments4/ours_memory/Preference_Memory_step2_ACTION_multiturn_api.py"

# 고정 데이터 경로
INPUT_PATH="/data/minseo/experiments4/data/1229_dev_6.json"
QUERY_PATH="/data/minseo/experiments4/query_new_multi.json"
...
echo "========================================================"
echo "Starting Cloud API Inference (Multi-turn Extended Hard)"
echo "========================================================"
...
for model in "${MODELS[@]}"; do
    ...
    for MEM_FOLDER in "${MEMORY_FOLDERS[@]}"; do
        ...
        BASE_OUTPUT_DIR="/data/minseo/experiments4/ours_memory/inference/extended/outputs/multiturn/api/${MEM_FOLDER}"
        BASE_LOG_DIR="/data/minseo/experiments4/ours_memory/inference/extended/logs/multiturn/api/${MEM_FOLDER}"
