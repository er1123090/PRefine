...
PYTHON_SCRIPT="/data/minseo/experiments5/extended_schema/mem0/inference_api_singleturn_fixed_pairs.py"
...
RUN_ROOT="/data/minseo/experiments5/extended_schema/mem0/output"
DATE_TAG="$(date +%m%d)"
