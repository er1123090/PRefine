...
ROOT = Path("/data/minseo/experiments4/extended_schema/mem0")
...
SINGLE_SOURCE = Path("/data/minseo/experiments4/mem0/step2_evaluate_singleturn.py")
MULTI_SOURCE = Path("/data/minseo/experiments4/mem0/step2_evaluate_multiturn.py")

SINGLE_SCHEMA_PATH = Path("/data/minseo/experiments4/schema_easy_extended.json")
MULTI_SCHEMA_PATH = Path("/data/minseo/experiments4/schema_all_extended_complete.json")
