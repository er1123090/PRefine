...
PYTHON_SCRIPT="/data/minseo/experiments5/extended_schema/langmem/langmem_inference_single_fixed_pairs.py"
...
MEMORY_ROOT="${MEMORY_ROOT:-/data/minseo/experiments5/methods/langmem/memory_snapshots/semantic-custom}"
CANONICAL_SNAPSHOT_NAME="${CANONICAL_SNAPSHOT_NAME:-langmem_1229_dev_6.jsonl}"

RUN_ROOT="/data/minseo/experiments5/extended_schema/langmem/output"
DATE_TAG="$(date +%m%d)"
