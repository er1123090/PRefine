...
PYTHON_SCRIPT="/data/minseo/experiments5/extended_schema/rag/inference_api_singleturn_fixed_pairs.py"
...
DB_PATH="${DB_PATH:-/data/minseo/experiments5/methods/rag/chroma_db_rag}"
COLLECTION_NAME="${COLLECTION_NAME:-user_memories}"

RUN_ROOT="/data/minseo/experiments5/extended_schema/rag/output"
DATE_TAG="$(date +%m%d)"
